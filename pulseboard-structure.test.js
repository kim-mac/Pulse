...
expect(/id="useDemoConnectionButton"/, "expected a reset-to-demo connection action");
...
expect(/Override API Key[\s\S]*\(Need your own key\? Get here\)/i, "expected override-friendly API key help shortcut copy inline with the API key label");
...
expect(/Use the demo connection or add your own credentials for this tab\./i, "expected demo-ready connection page heading");
expect(/built-in demo provider is available, PulseBoard will use it automatically/i, "expected API page to explain built-in demo access");
...
expect(/function hydrateDemoConnectionStatus\(/, "expected a demo-connection status hydration helper");
expect(/function applyConnectionStatus\(/, "expected a helper to merge built-in connection status into UI state");
expect(/function serializeConnectionForRelay\(/, "expected a helper to avoid sending built-in demo keys from the browser");
expect(/function useBuiltInDemoConnection\(/, "expected a reset-to-demo connection helper");
...
expect(/\.badge\.connected/, "expected a green connected badge state");
...
expect(/fetch\(["'`]\/api\/pulseboard\/connection-status["'`]\)/, "expected frontend to query safe built-in connection status");
